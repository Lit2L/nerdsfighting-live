  ...
  return (
    <div className='flex h-[350px] space-x-4'>
      <InfiniteSlider direction='vertical'>
        ...
        />
        <img
          src='_static/photos/mitts1.png'
          alt='Jungle Jack - JUNGLE DES ILLUSIONS VOL 2'
          className='aspect-square w-[120px] rounded-[4px]'
        />
        <img
          src='_static/photos/gauntlet1.png'
          alt='Yung Lean - Stardust'
          className='w-[120px] rounded-[4px] object-cover'
        />
        <img
          src='_static/photos/game.png'
          alt='Lana Del Rey - Ultraviolence'
          className='w-[120px] rounded-[4px]'
        />
        <img
          src='_static/photos/group-wes.jpeg'
          alt='A$AP Rocky - Tailor Swif'
          className='w-[120px] rounded-[4px]'
        />
        <img
          src='/_static/photos/nov-nerds.png'
          alt='Midnight Miami (feat Konvy) - Nino Paid, Konvy'
          className='w-[120px] rounded-[4px]'
        />
      </InfiniteSlider>
