...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'm-1 rounded-md bg-[#303030] p-3 text-center font-orbitron text-sm font-bold tracking-widest text-[#f5f5f5]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      'text-md rounded-lg px-6 py-2 font-genos font-semibold tracking-wider text-neutral-200',
      className
    )}
    {...props}
  />
