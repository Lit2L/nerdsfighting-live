...
export function BackgroundCircles({
  ...
  return (
    ...
    >
      <motion.div className='absolute h-[400px] w-[400px]'>
        {[0, 1, 2].map((i) => (
          <motion.div
            key={i}
            className={clsx(
      ...
      <motion.div
        className='relative z-10 flex flex-col items-center justify-center border-4 text-center'
      ...
      >
        ...
        />
        <motion.p
          className='mt-6 text-lg text-slate-950 dark:text-white md:text-xl'
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
  ...
  return (
    <>
      ...
      <div className='absolute right-12 top-12'>
        <button
          type='button'
          className='z-10 rounded-md bg-slate-950 px-4 py-1 text-sm font-medium text-white'
          onClick={() => {
