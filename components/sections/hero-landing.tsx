...
export default async function HeroLanding() {
  return (
    ...
    >
      ...
      {/* MIDDLE */}
      <div className='relative z-0 h-96 w-96 opacity-70 transition-all duration-300'>
        <div className='absolute h-96 w-96 border-double opacity-90 drop-shadow-2xl transition-all duration-300'>
          {/* <Logo /> */}
        </div>
      </div>
