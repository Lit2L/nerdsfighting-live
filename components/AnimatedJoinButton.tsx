  ...
  return (
    ...
    >
      <AnimatedShinyText className='inline-flex items-center justify-center transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400'>
        ...
        <span className='font-orbitron text-xs font-bold capitalize text-white md:text-[14px]'>
          Start Training For Free!
        </span>

        <span className='ml-3 transition-transform ease-in-out group-hover:-translate-x-2'>🥊</span>
      </AnimatedShinyText>
    </Link>
    // </div>
  )
