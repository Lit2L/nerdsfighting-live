...
export function PricingPack({ userId, subscriptionPlan }: PricingCardsProps) {
    ...
    return (
      ...
      >
        <div className='min-h-[150px] items-start space-y-4 bg-muted/50 p-6'>
          <p className='font-orbitron flex text-sm font-bold uppercase tracking-wider text-muted-foreground'>
            {offer.title}
          </p>
